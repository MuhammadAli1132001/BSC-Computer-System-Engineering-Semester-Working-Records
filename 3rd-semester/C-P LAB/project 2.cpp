...
name[16]="Anees Ahmed ";name[17]="Muhammad uzair";name[18]="Muhammad Asim";name[19]="Muhammad Ali";name[20]="Majid ullah ";
    ...
    gpa[16]=2.1;gpa[17]=2.3;gpa[18]=3.1;gpa[19]=2.1;gpa[20]=2.6;
     ...
     eata[11]=345 ;eata[12]= 309;eata[13]=400 ;eata[14]=195 ;eata[15]=315;eata[16]=290;eata[17]=336;eata[18]=407 ;eata[19]=390 ;eata[20]= 388;
      ...
      void outer(){
          if(get=="19pwcse1763"){
           ...
           cout<<"Semester number of the student is "<<semester[1]<<endl;
     ...
     if(get=="19pwcse1786"){
      ...
      if(get=="19pwcse1759"){
           ...
           cout<<"Semester number of the student is "<<semester[3]<<endl;
    ...
    if(get=="19pwcse1812"){
           ...
           cout<<"Semester number of the student is "<<semester[4]<<endl;
        ...
        if(get=="19pwcse1"){
           ...
           cout<<"Semester number of the student is "<<semester[5]<<endl;
